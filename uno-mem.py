...
import wandb
from data.get_dataset import get_replay_datasets
...
def main(args):
    ...
    dataset = get_replay_datasets(args.dataset, args)
...
if __name__ == "__main__":
    ...
    main(args)
    # python uno-mem.py --dataset CIFAR100Con --gpus 0 --max_epochs 200 --batch_size 512 --num_labeled_classes 50 --num_unlabeled_classes 50
    # --pretrained checkpoints/pretrained/supervised-CIFAR100-resnet18-labeled-50-unlabeled-50-ratio-100.pth --num_heads 4 --comment UNO-replay-one
    # --offline  --multicrop --amp --overcluster_factor 1 --choice_ratio 0.4 --regenerate
