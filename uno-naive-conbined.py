...
# In the second stage, unlabelled classes are learned here
...
def main(args):
    ...
    if args.resume:
        ...
        #If resume, replace "..........." with the real path
...
if __name__ == "__main__":
    ...
    parser.add_argument("--task-aware", default=False, action="store_true", help="whether can see task catagory during testing")
